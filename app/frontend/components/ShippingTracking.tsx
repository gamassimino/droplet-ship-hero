...
const ShippingTracking: React.FC<TableProps> = () => {
              ...
              <tr key={index} className="hover:bg-gray-50">
                <td className="px-6 py-4 whitespace-nowrap">
                  <div>
                    ...
                    <div className="text-sm text-gray-500">{item.eventId}</div>
                  </div>
                </td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{item.object}</td>
                <td className="px-6 py-4 whitespace-nowrap">
